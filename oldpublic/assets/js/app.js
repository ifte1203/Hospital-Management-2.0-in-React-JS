...
$(document).ready(function($) {
	...
	// var $('.main-wrapper') = $('.main-wrapper');
	// var $('.page-wrapper') = $('.page-wrapper');
	// var $('.slimscroll') = $('.slimscroll');
	// var $('.sidebar-overlay') = $('.sidebar-overlay');
	...
	function init() {
		...
		$('#sidebar-menu a').on('click', function(e) {
			...
			console.log('hello: '+$('.sidebar-overlay').removeClass('opened'));
	...
	function sidebar_overlay($target) {
		// alert('sidebar_overlay function');
		if($target.length) {
			$target.toggleClass('opened');
			$('.sidebar-overlay').toggleClass('opened');
			$('html').toggleClass('menu-opened');
			$('.sidebar-overlay').attr('data-reff', '#' + $target[0].id);
		}
	}
	...
	$('.page-wrapper').css('min-height', pHeight);
	$(window).resize(function() {
		var prHeight = $(window).height();
		$('.page-wrapper').css('min-height', prHeight);
	});
	...
	$(document).on('click', '#open_msg_box', function() {
		$('.main-wrapper').toggleClass('open-msg-box');
		return false;
	});
